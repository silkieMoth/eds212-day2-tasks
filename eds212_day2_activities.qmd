...
ggplot(data = my_data_range_2, aes(x = a)) + geom_function(fun = eq2, color = "red")
...
ggplot(data = penguins, aes(x = species, y = flipper_length_mm)) + geom_point() + geom_jitter() + labs(x = "Species", y = "Flipper Length (mm)", title = "Flipper Length in Penguins by Species")
